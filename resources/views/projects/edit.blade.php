            ...
            <form class="row g-3" method="POST" action="{{ route('projects.update', $project) }}">
                ...
                <div class="col-4">
                    ...
                    <select id="category" name="category" class="form-select">
                        ...
                        <option value="Front-end" {{ $project->category === 'Front-end' ? 'selected' : '' }}>
                            Front-end
                        </option>
                        <option value="Back-end" {{ $project->category === 'Back-end' ? 'selected' : '' }}>
                            Back-end
                        </option>
                        <option value="Web Design" {{ $project->category === 'Web Design' ? 'selected' : '' }}>
                            Web Design
                        </option>
                        <option value="Full-Stack" {{ $project->category === 'Full-Stack' ? 'selected' : '' }}>
                            Full-Stack
                        </option>
                    </select>
                </div>
