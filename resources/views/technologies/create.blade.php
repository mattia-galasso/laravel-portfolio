...
<div class="container">
    <div class="card pt-1 px-3 pb-3">
        <div class="card-body">
            <h3 class="card-title text-center">Nuova Tecnologia</h3>
            <hr class="my-4">
            <form class="row g-3" method="POST" action="{{ route('technologies.store') }}">
                ...
                <div class="col-6 d-flex flex-column
                 justify-content-center align-items-center">
                    ...
                    <input type="color" class="form-control form-control-color" id="color" value="#563d7c" title="Scegli un colore" name="color">
                </div>
                <hr class="my-5">
